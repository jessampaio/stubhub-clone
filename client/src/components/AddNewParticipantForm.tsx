...
const AddNewParticipantForm = (props: Props) => {
  ...
  const getParticipants = () => {
    axios
      .get('http://ec2-3-82-103-251.compute-1.amazonaws.com:3001/participants')
  ...
  const handleAddNewParticipant = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    axios
      .post('http://ec2-3-82-103-251.compute-1.amazonaws.com:3001/participants', { ...newParticipant })
      .then((response) => {
        setShowModal(false)
